...
CREATE TABLE IF NOT EXISTS `classes` (
  ...
  `clas_name` varchar(128) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `questions` (
  ...
  `ques_category` varchar(256) NOT NULL,
  `ques_question` varchar(512) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `recommendas` (
  ...
  `reca_answer` varchar(256) NOT NULL,
  PRIMARY KEY (`raid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `recommendqs` (
  ...
  `recq_category` varchar(256) NOT NULL,
  `recq_question` varchar(512) NOT NULL,
  `recq_user` varchar(256) NOT NULL,
